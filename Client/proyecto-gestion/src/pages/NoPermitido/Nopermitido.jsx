...
import { Link } from 'react-router-dom'; // Importa Link para manejar enlaces internos en React Router
    ...
    return (
        <div className="flex flex-col items-center h-screen w-full ">
            ...
            <div className=" p-8 rounded-lg shadow-md text-center m-auto bg-white">
                <img src="https://media.tenor.com/0xfAbrRRBjUAAAAi/cat-up.gif" alt="gatito" className='w-60 mx-auto my-5' />
